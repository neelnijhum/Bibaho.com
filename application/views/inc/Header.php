...
<html lang="en">
<head>
<title>Match Fix Wedding Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<link href="<?=base_url()?>assets/css/css_slider.css" type="text/css" rel="stylesheet" media="all">
...
<header>
	<div class="top-head container">
		<div class="ml-auto text-right right-p">
			<ul>
				<li class="mr-3">
					<span class="fa fa-phone"></span>+88 013 04111626</li>
				<li>
					<span class="fa fa-envelope-open"></span> <a href="mailto:info@example.com">info@bibaho.com</a> </li>
			</ul>
		</div>
	</div>
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<h1> <a href="index.html"><span class="fa fa-gift"></span> Bibaho.com </a></h1>
			</div>
